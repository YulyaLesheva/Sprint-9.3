...
SIGNUP_HEADER = "//h1[contains(text(),'Регистрация')]"
...
HEADER_CREATE_ACCOUNT_BUTTON = "//a[contains(text(),'Создать аккаунт')]"
HEADER_LOGOUT_BUTTON = "//a[contains(text(),'Выход')] | //button[contains(text(),'Выход')] | //span[contains(text(),'Выход')]"
